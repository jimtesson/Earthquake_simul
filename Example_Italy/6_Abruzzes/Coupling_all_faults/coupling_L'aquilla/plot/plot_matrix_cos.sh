...
fileu="../output/SLIP/u_2Fc_$k"
fig="CFS_cos/map_cos_${faultname[$k]}.ps"


gmt psbasemap -Jx0.13 -Ba20f10:"x":/a20f10:"y":WeSn -R$Rextent -X3 -P -Y6 -K > $fig

#fault-trace
gmt psxy <<! -J -R -W3 -Sf-1/0.2+r -K -O  >> $fig # F1
>
${xsf[$k]} ${ysf[$k]}
${xff[$k]} ${yff[$k]}
>
...
then
echo $k $j $mat
gmt psxy <<! -J -R -W3 -Cgmt/CFS_matrix.cpt -Sf-1/0.2+r -K -O  >> $fig # F1
> -Z$mat
${xsf[$j]} ${ysf[$j]}
${xff[$j]} ${yff[$j]}
>
